...
from shared.middleware.auth import verify_firebase_token, get_user_role, require_auth
from shared.middleware.rate_limiting import rate_limit
from shared.utils.firebase_config import get_firestore_client, get_auth_client
