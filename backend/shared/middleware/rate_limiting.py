...
def rate_limit(requests_per_hour=None, requests_per_minute=None):
    ...
    def decorator(f):
        ...
        def decorated_function(*args, **kwargs):
            ...
            hourly_limit = requests_per_hour or int(os.getenv('RATE_LIMIT_REQUESTS_PER_HOUR', 1000))
            minute_limit = requests_per_minute or int(os.getenv('RATE_LIMIT_REQUESTS_PER_MINUTE', 60))
