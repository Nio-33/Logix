...
class GeminiClient:
    ...
    def optimize_route(
        self, stops: List[Dict[str, Any]], constraints: Dict[str, Any] = None
    ) -> Dict[str, Any]:
        """
    ...
    def analyze_delivery_image(
        ...
        try:
            ...
            response = self.vision_model.generate_content(
                [prompt, image_part], safety_settings=self.safety_settings
            )
    ...
    def predict_demand(
        self, historical_data: List[Dict[str, Any]], product_info: Dict[str, Any] = None
    ) -> Dict[str, Any]:
        """
    ...
    def _build_route_optimization_prompt(
        self, stops: List[Dict[str, Any]], constraints: Dict[str, Any] = None
    ) -> str:
        """
    ...
    def _parse_route_response(
        self, response: str, original_stops: List[Dict[str, Any]]
    ) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            return {
                "optimized_sequence": [
                    stop.get("id", i) for i, stop in enumerate(original_stops)
                ],
                "total_distance_km": 0,
