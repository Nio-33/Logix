...
def create_app(config_name='development'):
    ...
    def admin_dashboard():
        ...
        try:
            import os
            frontend_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'frontend', 'admin', 'index.html')
    ...
    def serve_js(filename):
        ...
        try:
            import os
            js_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'frontend', 'admin', 'js', filename)
            with open(js_path, 'r') as f:
                return f.read(), 200, {'Content-Type': 'application/javascript'}
        except Exception as e:
            return f'// Error loading {filename}: {e}', 404, {'Content-Type': 'application/javascript'}
    ...
    def test_chart():
        ...
        try:
            import os
            test_path = os.path.join(os.path.dirname(__file__), '..', 'tests', 'frontend', 'test_chart.html')
    ...
    def simple_chart():
        ...
        try:
            import os
            test_path = os.path.join(os.path.dirname(__file__), '..', 'tests', 'frontend', 'simple_chart_test.html')
            with open(test_path, 'r') as f:
                return f.read()
        except Exception as e:
    ...
    def minimal_test():
        ...
        try:
            import os
            test_path = os.path.join(os.path.dirname(__file__), '..', 'tests', 'frontend', 'minimal_test.html')
            with open(test_path, 'r') as f:
                return f.read()
        except Exception as e:
